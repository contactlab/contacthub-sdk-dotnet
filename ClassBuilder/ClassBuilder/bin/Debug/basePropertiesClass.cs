/* selfgenerated from version 0.0.0.1 19/03/2018 15:22:54 */
...
[JsonProperty("hidden_type")][JsonIgnore]
                    public MobileDevicesTypeEnum type 
            {
            	...
            	[Display(Name="APN -> Apple Push Notification Service; GCM -> Google Cloud Messaging; WNS -> Windows Push Notification Services; ADM -> Amazon Device Messaging; SNS -> Amazon Simple Notification Service")]
[JsonProperty("notificationService")]public string _notificationService {get;set;}
[JsonProperty("hidden_notificationService")][JsonIgnore]
                    public MobileDevicesNotificationServiceEnum notificationService 
            {
                get
                {
                        MobileDevicesNotificationServiceEnum enumValue =ContactHubSdkLibrary.EnumHelper<MobileDevicesNotificationServiceEnum>.GetValueFromDisplayName(_notificationService);
                        return enumValue;
                }
                set
                {
                        var displayValue = ContactHubSdkLibrary.EnumHelper<MobileDevicesNotificationServiceEnum>.GetDisplayValue(value);
                        _notificationService = (displayValue=="NoValue"? null : displayValue);
                }
            }
            }

public enum MobileDevicesNotificationServiceEnum {
	NoValue,
	[Display(Name="APN")]
	APN,
	[Display(Name="GCM")]
