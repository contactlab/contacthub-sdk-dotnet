/* selfgenerated from version 0.0.0.1 09/07/2018 17:00:53 */
...
namespace ContactHubSdkLibrary
{
    ...
    public class MobileDevices
    {
        ...
        [JsonProperty("notificationService")]
        public string _notificationService { get; set; }
        [JsonProperty("hidden_notificationService")]
        [JsonIgnore]
