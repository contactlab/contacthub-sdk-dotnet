        ...
        public void CustomerAddEvent(string tpWorkspaceID, string tpTokenID, string tpNodeID, bool tpResult)
        {
            ...
            if (node != null)
            {
                ...
                if (newCustomer != null && newCustomer.id != null)
                {
                    ...
                    string result = node.AddEvent(newEvent);
                    if (result == "Accepted")
                    {
                        testPassed1 = true;
                    }
        ...
        public void CustomerAddEventWithComplexProperties(string tpWorkspaceID, string tpTokenID, string tpNodeID, bool tpResult)
        {
            ...
            if (node != null)
            {
                ...
                if (newCustomer != null && newCustomer.id != null)
                {
                    ...
                    bool pageIsValid = node.GetEvents(ref pagedEvents, 10, newCustomer.id, null, null, null, null, null);
                    ...
                    bool testPassed4 = node.DeleteCustomer(newCustomer.id);
        ...
        public void CustomerAddEventWithExtIdReconciliation(string tpWorkspaceID, string tpTokenID, string tpNodeID, bool tpResult)
        {
            ...
            if (node != null)
            {
                ...
                string extID = DateTime.Now.Ticks.ToString();
                {
                    ...
                    Customer extIdCustomer = node.GetCustomerByExternalID(extID);
                    ...
                    Customer updatedCustomer = node.UpdateCustomer(postCustomer, customerID, false);
                    ...
                    PagedEvent pagedEvents = null;
                    bool pageIsValid = node.GetEvents(ref pagedEvents, 10, customerID, null, null, null, null, null);
                    ...
                    //delete customer
                    bool testPassed5 = node.DeleteCustomer(updatedCustomer.id);
        ...
        public void CustomerAddEventWithSessionIdReconciliation(string tpWorkspaceID, string tpTokenID, string tpNodeID, bool tpResult)
        {
            ...
            if (node != null)
            {
                ...
                string extID = DateTime.Now.Ticks.ToString();
                {
                    ...
                    Thread.Sleep(1000);
                    Session returnSession = node.AddCustomerSession(newCustomer.id, currentSession);
        ...
        public void EventPaging(string tpWorkspaceID, string tpTokenID, string tpNodeID, int maxEvents, bool tpResult)
        {
            ...
            if (node != null)
            {
                ...
                if (newCustomer != null && newCustomer.id != null)
                {
                    ...
                    PagedEvent pagedEvents = null;
                    bool pageIsValid = node.GetEvents(ref pagedEvents,pageSize,newCustomer.id,null,null,null,null,null);
                    ...
                    if (pageIsValid)
                    {
                        ...
                        {
                            testPassed3 = testPassed3 || node.GetEvents(ref pagedEvents, PageRefEnum.next);
                            totPage++;
                        }
                    }
                    ...
                    //test filter
                    pagedEvents = null;
                    pageIsValid = node.GetEvents(ref pagedEvents, pageSize, newCustomer.id, EventTypeEnum.clickedLink, EventContextEnum.OTHER,EventModeEnum.ACTIVE, DateTime.Now.AddDays(-1), DateTime.Now.AddDays(1));
                    ...
                    if (pageIsValid)
                    {
                        ...
                        for (int i = 1; i < pagedEvents.page.totalPages; i++)
                        {
                            testPassed7 = testPassed7 || node.GetEvents(ref pagedEvents, PageRefEnum.next);
                            totPage++;
                        }
                    }
